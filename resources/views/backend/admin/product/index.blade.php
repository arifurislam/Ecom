        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title d-flex justify-content-between align-items-center">
                    <h4>All Category</h4>
                    <a href="{{url('admin/categories/create')}}" class="btn btn-primary"><i
                            class="icon-plus menu-icon pr-2"></i> New Category</a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="action-icon">
                                    ...
                                    <a href="{{url('admin/categories/' . $data->id . '/edit')}}"><i
                                            class="icon-pencil menu-icon pr-2"></i></a>
                                    <button type="submit" class="dlt-button" onclick="deleteCategory({{$data->id}})">
                                        <i class="icon-trash menu-icon pr-2"></i>
                                    </button>
                                    <form id="delete-form-{{$data->id}}"
                                        action="{{url('admin/categories/delete/' .$data->id)}}" method="post">
                                        @csrf
                                    </form>
                                </td>
                            </tr>
