        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="card-title text-primary">Update Brand Information</h4>
                    <a href="{{url('admin/brands')}}" class="btn btn-danger"><i
                            class="icon-arrow-left menu-icon pr-2"></i>All Brand</a>
                </div>
                <div class="basic-form">
                    <form method="post" action="{{url('admin/brands/' .$brand->id)}}">
                        ...
                        <div class="form-group {{$errors->has('name')? 'has-error':''}}">
                            <input type="text" name="name" class="form-control input-flat" value="{{$brand->name}}">
