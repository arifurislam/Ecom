...
<body>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{url('admin/brands')}}" aria-expanded="false"
                            class="{{Request::is('admin/brands*') ? 'active':''}}">
                            <i class="icon-grid menu-icon"></i><span class="nav-text">Brands</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('admin/products')}}" aria-expanded="false"
                            class="{{Request::is('admin/products*') ? 'active':''}}">
                            <i class="icon-notebook menu-icon"></i><span class="nav-text">Products</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('admin/coupons')}}" aria-expanded="false"
                            class="{{Request::is('admin/coupons*') ? 'active':''}}">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Coupon</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('logout') }}" aria-expanded="false"
                            ...
                            <i class="icon-power menu-icon"></i><span class="nav-text">Log Out</span>
                        </a>
    ...
    <script src="{{asset('admin')}}/js/jquery_2.2.4_jquery.min.js"></script>
