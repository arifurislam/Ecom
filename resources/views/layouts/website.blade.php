...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="{{url('/')}}"><img src="{{asset('website')}}/img/logo.png" alt=""></a>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <a class="text-primary" href="{{url('/admin/dashboard')}}">Dashboard</a>
                            @endif

                            @if(Auth::user()->role_id == 0)
                            <a class="text-primary" href="{{url('/dashboard/user')}}">Dashboard</a>
                            @endif
                            @endguest
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        @php
                        $totalWishlist = App\Models\WIshlist::where('user_id',Auth::id())->count();
                        $cardTotal = App\Models\Admin\Cart::all()->where('user_ip',request()->ip())->sum
                        (function($t){
                        return $t->qty * $t->price;
                        });
                        $totalCount = App\Models\Admin\Cart::all()->where('user_ip',request()->ip())->sum('qty');
                        @endphp
                        <ul>
                            <li><a href="{{url('/wishlist')}}"><i class="fa fa-heart"></i> <span>{{$totalWishlist}}</span></a></li>
                            <li><a href="{{url('/cart')}}"><i class="fa fa-shopping-bag"></i>
                                    <span>{{$totalCount}}</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>৳ {{$cardTotal}}</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <div class="footer__copyright__payment"><img src="{{asset('website')}}/img/payment-item.png"
                                alt=""></div>
                    </div>
                </div>
            </div>
